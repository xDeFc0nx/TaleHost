  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col justify-center items-center p-10 sm:py-10 sm:px-80 dark:bg-salafi-black bg-[#FBFAFF]">
        <div className=" sm:w-[40rem] sm:h-[38rem] mb-10 sm:mb-20">
          <div className="pl-[1rem] sm:pt-[4rem] pt-[1rem] sm:pl-[4rem]">
            <h1 className="font-bold text-4xl dark:text-[#FBFAFF]">
              Contact Us
            </h1>
            <ul className="mt-6 space-y-2">
              <li className="flex flex-col  sm:flex-row items-center dark:text-[#FBFAFF]">
